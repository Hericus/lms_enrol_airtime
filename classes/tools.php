...
/**
 * Classy locallib but not locallib for enrol_airtime.
 *
...
class tools {
     ...
     */
    const COMPONENT_NAME = 'enrol_airtime';
    ...
    public static function get_string($identifier = '', $a = null) {
        ...
        // Add to moodle config.php - $CFG->forced_plugin_settings = ['enrol_airtime' => ['resetlangstringcaches' => true]];.
