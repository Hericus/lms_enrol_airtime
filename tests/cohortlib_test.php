 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_airtime_lib_testcase extends advanced_testcase {

    /**
     * Test that a new group with the name of the cohort is created.
     */
    public function test_enrol_airtime_create_new_group() {
        global $DB;
        $this->resetAfterTest();
        // Create a category.
        ...
        // Run the function.
        $groupid = enrol_airtime_create_new_group($course->id, $cohort->id);
        // Check the results.
        ...
        $groupid = enrol_airtime_create_new_group($course2->id, $cohort->id);
    ...
    public function test_get_user_enrolment_actions() {
        ...
        // Teachers don't have enrol/airtime:unenrol capability by default. Login as admin for simplicity.
        $this->setAdminUser();
